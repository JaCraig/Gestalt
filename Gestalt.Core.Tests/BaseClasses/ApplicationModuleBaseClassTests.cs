...
namespace Gestalt.Core.Tests.BaseClasses
{
    public class ApplicationModuleBaseClass_1Tests : TestBaseClass
    {
        ...
        public void CanCallConfigureConfigurationSettings()
        {
            ...
            // Act
            IConfigurationBuilder? Result = _TestClass.ConfigureConfigurationSettings(Configuration, Environment, Args);
        ...
        [Fact]
        public void CanCallConfigureConfigurationSettingsWithNullArgs() => _TestClass.ConfigureConfigurationSettings(Substitute.For<IConfigurationBuilder>(), Substitute.For<IHostEnvironment>(), default);
        ...
        public void CanCallConfigureHostSettings()
        {
            ...
            // Act
            IHostBuilder? Result = _TestClass.ConfigureHostSettings(Host, Configuration, Environment);
        ...
        public void CanCallConfigureLoggingSettings()
        {
            ...
            // Act
            ILoggingBuilder? Result = _TestClass.ConfigureLoggingSettings(Logging, Configuration, Environment);
        ...
        {
            // Arrange
            IMetricsBuilder Metrics = Substitute.For<IMetricsBuilder>();
            IConfiguration Configuration = Substitute.For<IConfiguration>();
            IHostEnvironment Environment = Substitute.For<IHostEnvironment>();

            // Act
            IMetricsBuilder? Result = _TestClass.ConfigureMetrics(Metrics, Configuration, Environment);
        ...
        {
            IMetricsBuilder? Result = _TestClass.ConfigureMetrics(default, Substitute.For<IConfiguration>(), Substitute.For<IHostEnvironment>());
            Assert.Null(Result);
        }
        ...
        public void CanCallConfigureServices()
        {
            ...
            // Act
            IServiceCollection? Result = _TestClass.ConfigureServices(Services, Configuration, Environment);
        ...
        [InlineData("")]
        [InlineData("   ")]
        public void CanConstructWithInvalidCategory(string value) => _ = new TestApplicationModuleBaseClass(_Name, value, _ContentPath, _Tags);

        [Theory]
        [InlineData("")]
        [InlineData("   ")]
        public void CanConstructWithInvalidContentPath(string value) => _ = new TestApplicationModuleBaseClass(_Name, _Category, value, _Tags);

        [Theory]
        [InlineData("")]
        [InlineData("   ")]
        public void CanConstructWithInvalidName(string value) => _ = new TestApplicationModuleBaseClass(value, _Category, _ContentPath, _Tags);

        [Fact]
        public void CanConstructWithNullTags() => _ = new TestApplicationModuleBaseClass(_Name, _Category, _ContentPath, default);
        ...
        [Fact]
        public void CategoryIsInitializedCorrectly() => Assert.Equal(_Category, _TestClass.Category);

        [Fact]
        public void ContentPathIsInitializedCorrectly() => Assert.Equal(_ContentPath, _TestClass.ContentPath);
        ...
        [Fact]
        public void TagsIsInitializedCorrectly() => Assert.Same(_Tags, _TestClass.Tags);
