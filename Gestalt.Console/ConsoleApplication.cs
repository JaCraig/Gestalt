...
namespace Gestalt.Console
{
    ...
    /// </summary>
    /// <remarks>Initializes a new instance of the <see cref="ConsoleApplication"/> class.</remarks>
    /// <param name="configuration">Configuration</param>
    /// <param name="env">Host environment</param>
    /// <param name="assemblies">Assemblies</param>
    public class ConsoleApplication(IConfiguration? configuration, IHostEnvironment? env, params Assembly?[]? assemblies)
